...
class UserSeeder extends Seeder
{
    public function run()
    {
        ...
        $data = [
            [
                'id' => '1',
                'user_id' => 'DAP-ALO202403211239',
                'username' => 'Admin.Livestock.Ormin.2024',
                'password' => '$2y$10$fk5UIsyR9ascxKanB0aIo.MXzAoe0NMb.GO3G27qki3Pk/euozw86', // Replace with actual hashed password
                'email' => 'adminlsormin@gmail.com',
                'first_name' => 'Admin',
                'middle_name' => '', // Fill with appropriate middle name if available
                'last_name' => 'Livestock',
                'date_of_birth' => '2000-01-1', // Fill with actual date of birth
                'gender' => 'Male',
                'civil_status' => 'Single',
                'sitio' => '',
                'barangay' => 'Barcenaga',
